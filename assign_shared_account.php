...
$countries_qry = $conn->query("SELECT id, user_email AS name FROM netflix_stock WHERE active = 1 AND is_rplacement = 0 AND shared_acount = 1");
              ...
              <div class="row">
                <div class="col-md-6 form-group">
				  ...
				  <select type="text" name="seller" class="form-control" id="seller" placeholder="Seller" required>
                    ...
                    $countries = $conn->query("SELECT id, user_email AS name FROM netflix_stock WHERE  active = 1 AND is_rplacement = 0 AND shared_acount = 1");
