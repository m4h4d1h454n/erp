                 ...
                 <!-- All Here  -->
					<div class="panel panel-default">
                        <div class="panel-heading">
                            Netflix Stock Replace Panel
                        </div>
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-md-6">
                                    <h3>Netflix Stock Replace Panel</h3>
...
<script>
    ...
    var q = null;
      if (email == "") 
      {
        ...
        const url = "http://65.0.130.124:82/stock_send_replace?email="+email
        var reply = "\n"+email+"\n*****************************"
        fetch(url);
        alert ("***** Netflix Stock Sent to replace *****" + reply);
      }
}
