                 ...
                 <!-- All Here  -->
					<div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-md-6">
                                    <h3>User Renew Panel</h3>
            <form name="main" action="" method="GET">
              <div class="row">

                <div class="col-md-6 form-group mt-3 mt-md-0">
				<label>User ID</label>
                  <input type="email" class="form-control" name="email" id="email" placeholder="User ID" required>
                </div>
...
<script>
    ...
    var q = null;
      if (email == "") 
      {
        ...
        const url = "http://65.0.130.124:82/user_renew?email="+email
        var reply = "\n"+email+"\n*****************************"
        fetch(url);
        alert ("***** Netflix User Renewed *****" + reply);
      }
}
